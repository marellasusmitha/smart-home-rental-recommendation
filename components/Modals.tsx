      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
             ...
             <p className="mt-1 text-gray-800"><span className="font-semibold">Type:</span> {property.propertyType}</p>
             <p className="text-gray-800"><span className="font-semibold">Furnishing:</span> {property.furnishedType}</p>
        ...
        <div>
            ...
            <p className="mt-1 text-gray-800 font-mono break-all">{property.ownerEmail}</p>
        </div>
